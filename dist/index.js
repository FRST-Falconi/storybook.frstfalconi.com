...
function HeaderContent(props) {
    ...
    function RecomendationHeader(item) {
        return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("div", { className: style$2.title, children: item.title }), jsxRuntime.jsx("div", { className: style$2.description, children: item.description }), jsxRuntime.jsx("div", { style: { marginTop: 48 }, onClick: props.onClick, children: jsxRuntime.jsx(Button$2, { label: "Come\u00E7ar curso", variant: "primary" }) })] }));
    }
...
function StarMetric({ disabled, onChange }) {
    return (jsxRuntime.jsx(styled.ThemeProvider, { theme: FRSTTheme, children: jsxRuntime.jsx(WrapperCard$2, { children: jsxRuntime.jsxs(Box__default["default"], { children: [jsxRuntime.jsx(Typography__default["default"], { component: "legend" }), jsxRuntime.jsx(Rating__default["default"], { disabled: disabled ? disabled : false, onChange: (e) => { onChange(); } })] }) }) }));
}
...
function SubMenuMobile({ items, isVisible, setVisible, variant, languageSelected, onClickExit, onClickSite, onClickLinkedin, onClickInstagram, onClickYoutube, onClickSpotify, onClickPodCast }) {
    ...
    return (jsxRuntime.jsx(MenuMobile$1, { isVisible: isVisible, style: { zIndex: '10002' }, children: variant === 'LXP' ?
            ...
            :
                jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(ItemMenuMobile, { style: { paddingBottom: 32 }, onClick: () => setVisible(false), children: jsxRuntime.jsxs("span", { children: [" ", jsxRuntime.jsx(BackArrow, { fill: 'white' }), " \u00A0 ", languageSelected === 'en-US' ? 'Back' : 'Voltar'] }) }), options && options.length > 0 && options.map((item, index) => {
                                    if (item.label == 'Criar conteúdo')
                                        return;
                                    if (item.onClick == null)
                                        return jsxRuntime.jsxs(ItemMenuMobile, { onClick: (e) => item.onClick(e), children: [item.iconBegin, "\u00A0", item.label] }, index);
            ...
            return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: key === 0 ?
                    ...
                    :
                        jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [key === 1 &&
                                    jsxRuntime.jsx(TypographyMyTrails, { children: props.textMinhasTrihas ? props.textMinhasTrihas : 'Minhas Trilhas' }), jsxRuntime.jsx(AccordionTrackNormal, { id: data.id, TrailName: data.TrailName, ativo: data.ativo, handleChangeCheck: (bActive) => {
...
const SelectMultipesPrimeReact = styled__default["default"].div `
  width: 100%;
  .multiselect-custom {
    width: 100%;
    :hover {
...
`;
const SelectMultipesLabel = styled__default["default"].label `
  font-style: normal;
  font-weight: 400;
  font-size: 16px;
  line-height: 21px;
...
var css_248z = "/* ## header */\n\n.p-multiselect-panel .p-multiselect-header .p-checkbox .p-checkbox-box.p-highlight {\n  border-color: #ff4d0d;\n  background: #ff4d0d;\n}\n\n.p-multiselect-panel .p-multiselect-header .p-checkbox:not(.p-checkbox-disabled) .p-checkbox-box.p-highlight:hover {\n  border-color: #ff4d0d;\n  background: #ff4d0d;\n}\n\n.p-multiselect-panel .p-multiselect-header .p-checkbox .p-checkbox-box.p-highlight:not(.p-disabled):hover {\n  border-color: #ff4d0d;\n  background: #ff4d0d;\n}\n.p-multiselect-panel .p-multiselect-header .p-checkbox:not(.p-checkbox-disabled) .p-checkbox-box:hover {\n  border-color: #ff4d0d;\n}\n\n.p-multiselect-panel .p-multiselect-header .p-checkbox:not(.p-checkbox-disabled) .p-checkbox-box.p-focus {\n  outline: 0 none;\n  outline-offset: 0;\n  box-shadow: 0 0 0 0.2rem #e2beb0;\n}\n\n.p-multiselect-panel .p-multiselect-header .p-checkbox:not(.p-checkbox-disabled) .p-checkbox-box {\n  border-color: #ced4da;\n}\n\n.p-multiselect-panel .p-multiselect-header .p-multiselect-filter-container .p-inputtext:enabled:focus {\n  box-shadow: 0 0 0 0.2rem rgba(102, 51, 102, 0.4);\n  border-color: #663366;\n}\n\n/* ##Items wrapper  */\n\n.p-multiselect-panel .p-multiselect-items-wrapper .p-checkbox:not(.p-checkbox-disabled) .p-checkbox-box:hover {\n  border-color: #ff4d0d;\n}\n\n.p-multiselect-panel .p-multiselect-items-wrapper .p-checkbox .p-checkbox-box.p-highlight {\n  border-color: #ff4d0d;\n  background: #ff4d0d;\n}\n\n.p-multiselect-panel\n  .p-multiselect-items-wrapper\n  .p-checkbox:not(.p-checkbox-disabled)\n  .p-checkbox-box.p-highlight:hover {\n  border-color: #ff4d0d;\n  background: #ff4d0d;\n}\n\n.p-multiselect-panel .p-multiselect-items-wrapper .p-checkbox .p-checkbox-box.p-highlight:not(.p-disabled):hover {\n  border-color: #ff4d0d;\n  background: #ff4d0d;\n}\n\n.p-multiselect-panel .p-multiselect-items-wrapper .p-multiselect-items .p-multiselect-item:focus {\n  box-shadow: none;\n}\n\n.p-multiselect-panel\n  .p-multiselect-items-wrapper\n  .p-multiselect-items\n  .p-multiselect-item:not(.p-highlight):not(.p-disabled):hover {\n  background: #f7f9fc;\n}\n\n.p-multiselect-panel .p-multiselect-items-wrapper .p-multiselect-items .p-multiselect-item.p-highlight {\n  color: #525960;\n  background: #f2f2f2;\n}\n\n.p-multiselect-panel .p-multiselect-items-wrapper::-webkit-scrollbar {\n  width: 0.4rem;\n}\n\n.p-multiselect-panel .p-multiselect-items-wrapper::-webkit-scrollbar-track {\n  background: transparent;\n}\n\n.p-multiselect-panel .p-multiselect-items-wrapper::-webkit-scrollbar-thumb {\n  background-color: #c4c4c4;\n  border-radius: 20px;\n}\n";
styleInject(css_248z);

function DropdownSelectMultiple({ placeholderSelect, placeholderFilter, handleValueSelect, labelSelect, optionLabel, listItems, isDisabled }) {
    const [lazyItems, setLazyItems] = React.useState([]);
    const [lazyLoading, setLazyLoading] = React.useState(false);
    const [selectedListItems, setSelectedListItems] = React.useState(null);
    React.useEffect(() => {
    ...
    const panelFooterTemplate = () => {
        ...
        return (jsxRuntime.jsxs("div", { className: "py-2 px-3", children: [jsxRuntime.jsx("b", { children: length }), " item", length > 1 ? 's' : '', " selected."] }));
    };
    const selectedCountriesTemplate = (option) => {
        if (option) {
            return (jsxRuntime.jsx("div", { className: "country-item country-item-value", children: jsxRuntime.jsx("div", { children: option.name }) }));
        }
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(SelectMultipesLabel, { children: labelSelect ? labelSelect : 'label' }), jsxRuntime.jsx(SelectMultipesPrimeReact, { children: jsxRuntime.jsx(multiselect.MultiSelect, { value: selectedListItems, options: listItems, onChange: (e) => handleSelectItems(e.value), optionLabel: optionLabel, placeholder: placeholderSelect ? placeholderSelect : 'Por favor escolha', filter: listItems.length > 10, className: "multiselect-custom", selectedItemTemplate: selectedCountriesTemplate, panelFooterTemplate: panelFooterTemplate, panelStyle: css_248z, filterPlaceholder: placeholderFilter ? placeholderFilter : 'Pesquisar', disabled: isDisabled }) })] }));
}
...
function ChallengeCard({ variant, description, language, onClickView, onClickNewProject, onClickContinue, onClickDelete }) {
...
function BannerProblemFeed(props) {
    ...
    return (jsxRuntime.jsxs(styled.ThemeProvider, { theme: FRSTTheme, children: [props.mainAchievementValue || props.mainLearningValue ?
                ...
                : null, jsxRuntime.jsxs(bannerContainer, { style: { borderTopLeftRadius: props.mainAchievementValue || props.mainLearningValue ? 0 : 8, borderTopRightRadius: props.mainAchievementValue || props.mainLearningValue ? 0 : 8 }, children: [jsxRuntime.jsxs(headerContent, { children: [jsxRuntime.jsx(Avatar, { size: "40px", src: props.isSuccessCase ? 'https://i.gyazo.com/e9608cb76d36242de07661bee9da60dd.png' : props.userAvatar }), jsxRuntime.jsxs(userInfo, { children: [jsxRuntime.jsx("span", { style: { fontWeight: 600, fontSize: 20 }, children: props.isSuccessCase ?
                                                ...
                                                : props.language === 'en-US' ? 'Success case'
                                                    : props.language === 'es' ? 'Caso de exito'
                                                        : props.language === 'pt-PT' ? 'Case de sucesso'
                                                            : null)
                                            : props.userName }), jsxRuntime.jsx("span", { style: { fontWeight: 400, fontSize: 16 }, children: props.userPosition })] })] }), jsxRuntime.jsxs(problemTitle, { children: [" ", props.problemTitle, " "] }), jsxRuntime.jsx(tagContent, { children: props.problemTags?.map((item, index) => (item &&
...
exports.DropdownSelectMultiple = DropdownSelectMultiple;
