...
function ApprovesItem(props) {
    return (jsxRuntime.jsxs("div", { className: style$8.containerItem, children: [jsxRuntime.jsxs("div", { className: style$8.avatar, style: { width: props.size }, children: [jsxRuntime.jsx(Avatar, { src: props.avatar, size: props.avatarSize }), jsxRuntime.jsx("span", { className: style$8.name, children: props.nomeAvatar }), jsxRuntime.jsx("span", { className: style$8.sub_title, children: props.dataAvatar })] }), props.statusApprove === 'reviewed' ?
                jsxRuntime.jsx("div", { style: { minWidth: '48px', marginTop: '-40px' }, children: jsxRuntime.jsx(StatusProblemaSawBadgeIcon, {}) })
                : props.statusApprove === 'adjustments' ?
                    jsxRuntime.jsx("div", { style: { minWidth: '48px', marginTop: '-40px' }, children: jsxRuntime.jsx(StatusProblemaEdit, {}) })
                    :
                        jsxRuntime.jsx("div", { style: { minWidth: '48px', marginTop: '-40px' }, children: jsxRuntime.jsx(StatusProblemaSendIcon, {}) }), jsxRuntime.jsx("div", { style: { width: props.size }, className: style$8.status_logo, children: jsxRuntime.jsx(Avatar, { src: problemaFRST, size: props.avatarSize }) })] }));
}
