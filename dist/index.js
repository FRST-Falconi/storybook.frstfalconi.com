...
function MissionSteps(props) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { style: { display: "flex", justifyContent: 'center', width: '100%', position: 'relative', padding: 20, backgroundColor: 'white' }, children: [stepActive > 1 ?
                    size[0] >= BREAKWIDTH ?
                        jsxRuntime.jsx("span", { onClick: () => { setStep(stepActive - 1); }, className: style$7.missaoTitle, style: { position: 'absolute', top: 20, left: 20, cursor: 'pointer' }, children: `${"< Missão anterior"}` })
                        :
                            jsxRuntime.jsx("span", { onClick: () => { setStep(stepActive - 1); }, className: style$7.missaoTitle, style: { position: 'absolute', top: 20, left: 20, cursor: 'pointer' }, children: `${"< Ant."}` })
                    : null, stepActive < stepLiberado ?
                    size[0] >= BREAKWIDTH ?
                        jsxRuntime.jsx("span", { onClick: () => { setStep(stepActive + 1); }, className: style$7.missaoTitle, style: { position: 'absolute', top: 20, right: 20, cursor: 'pointer' }, children: `${"Próxima missão >"}` })
                        :
                            jsxRuntime.jsx("span", { onClick: () => { setStep(stepActive + 1); }, className: style$7.missaoTitle, style: { position: 'absolute', top: 20, right: 20, cursor: 'pointer' }, children: `${"Próx. >"}` })
...
function ApprovesItem(props) {
    return (jsxRuntime.jsxs("div", { className: style$4.containerItem, children: [jsxRuntime.jsxs("div", { className: style$4.avatar, children: [jsxRuntime.jsx(Avatar, { src: props.avatar, size: '120px' }), jsxRuntime.jsx("span", { style: { marginTop: 4, color: '#FF4D0D', fontWeight: 600 }, children: props.nomeAvatar }), jsxRuntime.jsx("span", { style: { fontSize: 14, color: '#222222', fontWeight: 400 }, children: props.dataAvatar })] }), props.statusApprove === 'aprovar' ?
                ...
                : props.statusApprove === 'revisar' ?
                    ...
                    :
                        jsxRuntime.jsx("div", { style: { minWidth: '48px' }, children: jsxRuntime.jsx(WarningInCicleIcon, {}) }), jsxRuntime.jsx("div", { style: { marginBottom: 30 }, children: jsxRuntime.jsx(Avatar, { src: problemaFRST, size: '120px' }) })] }));
}
