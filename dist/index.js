...
function Rating(props) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: style$8.container, style: { ...props.style }, children: [jsxRuntime.jsx("div", { className: style$8.titulo, style: { display: 'flex', justifyContent: 'flex-start', alignItems: 'center', fontSize: 16, fontWeight: 600 }, children: props.titulo }, void 0), jsxRuntime.jsxs("div", { className: style$8.content, style: { display: 'flex', width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start' }, children: [jsxRuntime.jsxs("div", { className: style$8.star, style: { display: 'inline-flex', width: 35, height: 35, position: 'relative', justifyContent: 'center', alignItems: 'center' }, children: [jsxRuntime.jsx(StarIcon, { color: MapColorStar[props.tipoVisualizacao - 1] }, void 0), jsxRuntime.jsx("span", { style: { position: 'absolute', fontSize: 10, color: MapColorNumberStar[props.tipoVisualizacao - 1], fontWeight: 'bold', top: 12, textAlign: 'center' }, children: props.nota }, void 0)] }, void 0), jsxRuntime.jsx("div", { className: style$8.avaliacao, children: jsxRuntime.jsxs("div", { style: { display: 'flex', flexDirection: 'column', flexWrap: 'wrap', width: 100 }, children: [jsxRuntime.jsx("span", { style: { fontSize: 14, fontWeight: 600 }, children: props.descricaoAvaliacao }, void 0), jsxRuntime.jsx("span", { style: { fontSize: 12, fontWeight: 400 }, children: `${props.qtdeAvaliacao} ${props.qtdeAvaliacao > 1 ? 'avaliações' : 'avaliação'}` }, void 0)] }, void 0) }, void 0)] }, void 0)] }, void 0) }, void 0));
}
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: style$6.container, style: { ...props.style }, onClick: () => {
                if (props.status !== 'B') {
                    props.onClick();
                        ...
                        : props.status === "I" ?
                            style$6.imgInative
                            : style$6.imgBlocked }, void 0), jsxRuntime.jsx("div", { className: style$6.label, children: TypeStepName[props.step - 1] }, void 0), props.status === 'B' &&
                    jsxRuntime.jsx("div", { className: style$6.block, children: jsxRuntime.jsx("img", { src: 'https://api-motor.s3.amazonaws.com/lock.png' }, void 0) }, void 0)] }, void 0) }, void 0));
}
...
function MissionSteps(props) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { style: { display: "flex", justifyContent: 'center', width: '100%', position: 'relative', padding: 20, backgroundColor: 'white' }, children: [stepActive > 1 &&
                    jsxRuntime.jsx("span", { onClick: () => { setStep(stepActive - 1); }, className: style$6.missaoTitle, style: { position: 'absolute', top: 20, left: 20, cursor: 'pointer' }, children: `${"< Missão anterior"}` }, void 0), stepActive < stepLiberado &&
                    jsxRuntime.jsx("span", { onClick: () => { setStep(stepActive + 1); }, className: style$6.missaoTitle, style: { position: 'absolute', top: 20, right: 20, cursor: 'pointer' }, children: `${"Próxima missão >"}` }, void 0), jsxRuntime.jsxs("div", { style: { display: "inline-flex", marginTop: 40, justifyContent: 'center' }, children: [jsxRuntime.jsx(Steps, { step: 1, status: stepLiberado >= 1 ? stepActive === 1 ? "A" : "I" : "B", onClick: () => {
                                setStep(1);
...
function BannerProblem(props) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: style$4.container, style: { ...props.style }, children: [jsxRuntime.jsx("span", { className: style$4.titleProblem, children: "Problema" }, void 0), props.isEditable &&
                    jsxRuntime.jsx(Button, { label: Edit ? "Salvar Alterações" : "Editar", variant: 'link', handleClick: () => {
                            setEdit(!Edit);
                        }, startIcon: jsxRuntime.jsx(EditIcon, {}, void 0) }, void 0), jsxRuntime.jsx("h1", { className: style$4.description, children: props.problema }, void 0), jsxRuntime.jsx("div", { style: { display: 'flex', justifyContent: 'space-between', position: 'relative', width: '100%', borderBottom: '1px solid #CCCCCC', paddingBottom: 32 }, children: jsxRuntime.jsxs("div", { style: { display: 'inline-flex', width: '80%' }, children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(AvatarWithInfo, { cargo: props.cargo, nomeCompleto: props.nome, fotoAvatar: props.avatar }, void 0), jsxRuntime.jsx(TextIcon, { description: props.area, svg: jsxRuntime.jsx(Brain, {}, void 0) }, void 0), jsxRuntime.jsx(TextIcon, { description: props.email, svg: jsxRuntime.jsx(Mail, {}, void 0) }, void 0), Edit ?
                                        ...
                                        :
                                            ...
                                            jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: style$4.contentInput, children: [jsxRuntime.jsx("h3", { style: { marginBottom: 12, textAlign: 'left', width: '100%', fontSize: 16 }, children: "Busque e selecione at\u00E9 tr\u00EAs palavras-chave:" }, void 0), jsxRuntime.jsx("input", { placeholder: 'Ex.: Customer Success' }, void 0), jsxRuntime.jsx("input", { placeholder: 'Ex.: Experi\u00EAncia do usu\u00E1rio' }, void 0), jsxRuntime.jsx("input", { placeholder: 'Ex.: CSAT' }, void 0)] }, void 0) }, void 0)
                                            :
                                                jsxRuntime.jsx(jsxRuntime.Fragment, { children: props.tags?.map((item, key) => (jsxRuntime.jsx(Tag, { title: item, color: "#222", style: { marginRight: 8, marginTop: 8 }, selected: false, inverted: false }, key))) }, void 0) }, void 0), jsxRuntime.jsx(MessageBox, { texto: props.message, tipoVisualizacao: props.typeMessagem, style: { marginBottom: 16 } }, void 0), jsxRuntime.jsx("span", { className: style$4.created, children: props.dataCriacao }, void 0)] }, void 0), jsxRuntime.jsxs("div", { style: { position: 'absolute', right: 0, flexFlow: 'column', justifyContent: 'flex-end', width: '20%' }, children: [jsxRuntime.jsx(Rating, { titulo: 'Impacto', descricaoAvaliacao: '\u00D3timo', qtdeAvaliacao: props.qtdeAvaliacao, nota: props.notaAvaliacao, tipoVisualizacao: 1 }, void 0), jsxRuntime.jsx(Rating, { titulo: 'Relev\u00E2ncia', descricaoAvaliacao: 'Bom', qtdeAvaliacao: props.qtdeRelevancia, nota: props.notaRelevancia, tipoVisualizacao: 1 }, void 0), jsxRuntime.jsx(RatingCurtidas, { titulo: 'Curtidas', qtdeCurtidas: props.curtidas, tipoBotao: 2 }, void 0)] }, void 0)] }, void 0) }, void 0), jsxRuntime.jsx(MissionSteps, { stepProblem: props.stepProblem, stepActive: props.stepActive, onSelected: (step) => {
...
function ModalLearningTech(props) {
    return (jsxRuntime.jsx(material.Modal, { open: props.open, onClose: props.handleClose, children: jsxRuntime.jsxs(material.Box, { className: style$2.modalBox, style: { ...props.style }, children: [jsxRuntime.jsxs("div", { className: style$2.fechar, onClick: props.handleClose, children: [jsxRuntime.jsx("span", { style: { marginRight: 10 }, children: " Fechar " }, void 0), " ", jsxRuntime.jsx(CloseIcon, {}, void 0)] }, void 0), jsxRuntime.jsx("div", { className: style$2.titulo, children: props.title }, void 0), jsxRuntime.jsx("div", { className: style$2.container, children: props.children }, void 0), jsxRuntime.jsx("div", { className: style$2.conclusao, children: props.confirmationButton ?
                        props.cancelButton ?
...
function CardProblem(props) {
    ...
    return (jsxRuntime.jsxs("div", { className: style.container, style: { border: '1px solid ', borderColor: statusColor, backgroundColor: selected ? '#FF4D0D' : '#FFF', color: selected ? '#FFF' : '#000' }, children: [jsxRuntime.jsx("div", { className: style.tagStatusProblem, style: { background: statusColor, color: statusName === "Hipótese Levantada" ? '#222222' : '#FFF' }, children: statusName }, void 0), jsxRuntime.jsx("div", { className: style.checkBox, onClick: () => {
                    setSelected(!selected);
                    props.handleSelect(props.problemID);
                }, children: selected ? jsxRuntime.jsx(CheckboxChecked, {}, void 0) : jsxRuntime.jsx(CheckboxEmpty, {}, void 0) }, void 0), jsxRuntime.jsxs("div", { className: style.contentCard, children: [jsxRuntime.jsxs("div", { className: style.avatarInfoUser, children: [jsxRuntime.jsxs("div", { children: [" ", jsxRuntime.jsx(Avatar, { size: '40px', src: props.userAvatar }, void 0), " "] }, void 0), jsxRuntime.jsxs("div", { className: style.infoUser, children: [jsxRuntime.jsx("span", { style: { fontSize: 16, fontWeight: 600 }, children: props.userName }, void 0), jsxRuntime.jsx("span", { style: { fontSize: 14, fontWeight: 400 }, children: props.userCargo }, void 0)] }, void 0)] }, void 0), props.cardTitle &&
                        jsxRuntime.jsxs("div", { className: style.tituloCard, style: { color: selected ? '#FFF' : '#FF4D0D', width: '100%' }, children: [jsxRuntime.jsx("span", { children: props.cardTitle }, void 0), jsxRuntime.jsx("div", { style: { marginLeft: 16 }, children: selected ?
                                        jsxRuntime.jsx(RocketButton, { tipoBotao: 1 }, void 0)
                                        :
                                            jsxRuntime.jsx(RocketButton, { tipoBotao: 2 }, void 0) }, void 0)] }, void 0), props.tags &&
                        jsxRuntime.jsx("div", { className: style.tagsContainer, children: props.tags.map((item, index) => (jsxRuntime.jsx(Tag, { title: item, color: '#050505', selected: false, inverted: true, style: { fontWeight: 500, fontSize: 14, marginRight: 8, marginTop: 8 } }, index))) }, void 0), props.ratingImpacto &&
