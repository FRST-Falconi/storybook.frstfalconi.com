...
function Lupa({ fill, width, height }) {
    return (jsxRuntime.jsx("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M3.2 10.6C3.2 6.51309 6.51309 3.2 10.6 3.2C14.6869 3.2 18 6.51309 18 10.6C18 12.6044 17.2031 14.4227 15.9088 15.7553C15.879 15.7758 15.8507 15.7993 15.8242 15.8258C15.7977 15.8522 15.7743 15.8805 15.7538 15.9102C14.4214 17.2037 12.6037 18 10.6 18C6.51309 18 3.2 14.6869 3.2 10.6ZM16.2413 17.0914C14.7312 18.4048 12.7585 19.2 10.6 19.2C5.85035 19.2 2 15.3496 2 10.6C2 5.85035 5.85035 2 10.6 2C15.3496 2 19.2 5.85035 19.2 10.6C19.2 12.7593 18.4042 14.7327 17.0899 16.243L21.0227 20.1758C21.257 20.4101 21.257 20.79 21.0227 21.0243C20.7884 21.2586 20.4085 21.2586 20.1742 21.0243L16.2413 17.0914Z", fill: fill ?? '#000000' }) }));
}
function ArrowIcon$2({ fill, width, height }) {
    return (jsxRuntime.jsx("svg", { width: width ? width : '14', height: height ? height : '7', viewBox: "0 0 14 7", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { d: "M7.1736 6.64904L13.521 0.992188H0.826172L7.1736 6.64904Z", fill: fill ?? '#222222' }) }));
}
...
function WhiteFilter({ fill, width, height }) {
    return (jsxRuntime.jsx("svg", { width: width ? width : '22', height: height ? height : '20', viewBox: "0 0 22 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { d: "M21 1H1L9 10.46V17L13 19V10.46L21 1Z", stroke: fill ? fill : 'white', strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }));
}
...
function CopyPaste({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M18 8.71875H11.25C10.4216 8.71875 9.75 9.5862 9.75 10.6562V19.375C9.75 20.4451 10.4216 21.3125 11.25 21.3125H18C18.8284 21.3125 19.5 20.4451 19.5 19.375V10.6562C19.5 9.5862 18.8284 8.71875 18 8.71875Z", stroke: fill ? fill : 'black', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M6.75 14.5312H6C5.60218 14.5312 5.22064 14.3271 4.93934 13.9638C4.65804 13.6004 4.5 13.1076 4.5 12.5937V3.875C4.5 3.36114 4.65804 2.86833 4.93934 2.50498C5.22064 2.14163 5.60218 1.9375 6 1.9375H12.75C13.1478 1.9375 13.5294 2.14163 13.8107 2.50498C14.092 2.86833 14.25 3.36114 14.25 3.875V4.84375", stroke: fill ? fill : 'black', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" })] }));
}
...
function Share({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M20 14.0789V20H5V5H12.8947", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M17 3L21 7L17 11", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M9 16C9 11.0294 13.3777 7 18.7778 7H20", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round" })] }));
}
...
function File({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M19 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H16L21 8V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21Z", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M17 21V13H6V21", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M6 3V8H15", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" })] }));
}
function Link({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M10.5 12.3904C10.9045 12.9228 11.4206 13.3634 12.0133 13.6822C12.6059 14.0011 13.2613 14.1907 13.9349 14.2382C14.6085 14.2857 15.2846 14.19 15.9174 13.9576C16.5501 13.7251 17.1247 13.3615 17.6022 12.8912L20.4279 10.1088C21.2858 9.23423 21.7606 8.06284 21.7498 6.84697C21.7391 5.63109 21.2438 4.46801 20.3706 3.60822C19.4974 2.74844 18.3161 2.26074 17.0813 2.25018C15.8464 2.23961 14.6567 2.70702 13.7685 3.55173L12.1484 5.13768", stroke: fill ? fill : 'black', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M14.25 10.8596C13.8455 10.3272 13.3294 9.88658 12.7367 9.56776C12.1441 9.24894 11.4887 9.05935 10.8151 9.01185C10.1415 8.96435 9.46538 9.06004 8.83263 9.29245C8.19988 9.52486 7.6253 9.88853 7.14785 10.3588L4.32205 13.1412C3.46415 14.0158 2.98945 15.1872 3.00018 16.403C3.01091 17.6189 3.50622 18.782 4.37943 19.6418C5.25263 20.5016 6.43387 20.9893 7.66873 20.9998C8.90358 21.0104 10.0933 20.543 10.9815 19.6983L12.5922 18.1123", stroke: fill ? fill : 'black', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" })] }));
}
function Dollar({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M12 3V21", stroke: fill ? fill : 'black', strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M16.1667 6H9.91667C9.14312 6 8.40125 6.31607 7.85427 6.87868C7.30729 7.44129 7 8.20435 7 9C7 9.79565 7.30729 10.5587 7.85427 11.1213C8.40125 11.6839 9.14312 12 9.91667 12H14.0833C14.8569 12 15.5987 12.3161 16.1457 12.8787C16.6927 13.4413 17 14.2044 17 15C17 15.7956 16.6927 16.5587 16.1457 17.1213C15.5987 17.6839 14.8569 18 14.0833 18H7", stroke: fill ? fill : 'black', strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })] }));
}
...
function WhitePaper({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z", stroke: "#222222", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M14 2V8H20", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M16 13H8", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M16 17H8", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M10 9H9H8", stroke: fill ? fill : '#222222', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" })] }));
}
...
function Code({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M16 18L22 12L16 6", stroke: fill ? fill : 'black', strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M8 6L2 12L8 18", stroke: fill ? fill : 'black', strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("line", { x1: "14.3281", y1: "4.62638", x2: "9.62638", y2: "19.6719", stroke: fill ? fill : 'black', strokeLinecap: "round" })] }));
}
function BarChart({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("rect", { x: "17.6", y: "3.6", width: "2.8", height: "16.8", rx: "1.4", stroke: fill ? fill : '#222222', strokeWidth: "1.2" }), jsxRuntime.jsx("rect", { x: "10.6", y: "8.6", width: "2.8", height: "11.8", rx: "1.4", stroke: fill ? fill : '#222222', strokeWidth: "1.2" }), jsxRuntime.jsx("rect", { x: "3.6", y: "15.6", width: "2.8", height: "4.8", rx: "1.4", stroke: fill ? fill : '#222222', strokeWidth: "1.2" })] }));
}
function Course({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsxs("g", { clipPath: "url(#clip0_3049_12002)", children: [jsxRuntime.jsx("path", { d: "M12.4873 2.9843C12.304 2.88251 12.081 2.88371 11.8989 2.98746L1.51408 8.90391C1.32591 9.01112 1.21012 9.2114 1.2111 9.42797C1.21208 9.64453 1.32969 9.84376 1.51883 9.94925L11.7141 15.6357C11.8971 15.7378 12.1202 15.737 12.3025 15.6335L22.7277 9.71708C22.9164 9.61002 23.0326 9.40945 23.0316 9.19253C23.0306 8.97561 22.9126 8.77611 22.723 8.67076L12.4873 2.9843Z", stroke: fill ? fill : 'black', strokeWidth: "1.2", strokeLinejoin: "round" }), jsxRuntime.jsx("line", { x1: "21.9643", y1: "10.6449", x2: "21.9643", y2: "16.2418", stroke: fill ? fill : 'black', strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M5.61621 12.1689V18.7074C5.61621 20.2446 8.75958 21.0486 11.8643 21.0486C14.9687 21.0486 18.1124 20.2445 18.1124 18.7074V12.1689", stroke: fill ? fill : 'black', strokeWidth: "1.2" })] }), jsxRuntime.jsx("defs", { children: jsxRuntime.jsx("clipPath", { id: "clip0_3049_12002", children: jsxRuntime.jsx("rect", { width: "24", height: "24", fill: "white" }) }) })] }));
}
function Palette({ fill, width, height }) {
    return (jsxRuntime.jsxs("svg", { width: width ? width : '24', height: height ? height : '24', viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M14.2396 11.9956L14.2398 11.9957M10.1269 2.25C5.40307 2.25 1.54883 5.35765 1.54883 9.16141C1.54883 12.3436 4.228 15.1032 8.08224 15.8739C8.50519 15.9485 8.85779 15.9983 9.21027 15.9983C10.7614 15.9983 11.349 15.128 11.8894 14.3574C12.4065 13.6115 12.853 12.9652 14.2631 12.9652C17.1537 12.9652 18.7283 11.0013 18.7283 9.16145C18.7049 5.35768 14.8507 2.25004 10.1268 2.25004L10.1269 2.25Z", stroke: fill ? fill : 'black', strokeWidth: "1.2" }), jsxRuntime.jsx("path", { d: "M12.7529 8.40078C12.7529 9.41483 13.5727 10.2098 14.6203 10.2098C15.6678 10.2098 16.4876 9.41503 16.4876 8.40078C16.4876 7.38673 15.6678 6.5918 14.6203 6.5918C13.5727 6.59199 12.7529 7.38673 12.7529 8.40078Z", stroke: fill ? fill : 'black', strokeWidth: "1.2" }), jsxRuntime.jsx("path", { d: "M22.4921 14.2449C22.4921 14.2449 20.3703 13.2873 19.2979 13.8118C19.0802 13.9197 18.8984 14.0947 18.7764 14.3138C18.6562 14.5278 18.5936 14.7725 18.5955 15.0213L19.408 16.8826C19.5858 17.0455 19.8024 17.1537 20.0342 17.1955C20.271 17.2392 20.5147 17.2061 20.7334 17.1005C21.8058 16.576 22.4921 14.2449 22.4921 14.2449Z", stroke: fill ? fill : 'black', strokeWidth: "1.2" }), jsxRuntime.jsx("path", { d: "M7.50555 21.726C7.59891 21.9399 7.76717 22.1071 7.97459 22.1918C8.18202 22.2765 8.41221 22.2722 8.61642 22.1798L17.0364 18.3698C17.1777 18.3056 17.4233 18.1096 17.4233 18.1096L16.9794 17.0926L16.5355 16.0756C16.3831 16.0983 16.2353 16.1466 16.0974 16.2189L7.89905 20.5366C7.70019 20.6413 7.54791 20.8241 7.47444 21.0462C7.40094 21.2683 7.41217 21.5121 7.50555 21.726Z", stroke: fill ? fill : 'black', strokeWidth: "1.2" })] }));
}
...
var icons = /*#__PURE__*/Object.freeze({
  ...
  EditIcon: EditIcon,
  WarningIcon: WarningIcon$1,
  FRSTLogo: FRSTLogo,
  FRSTLogoBig: FRSTLogoBig,
  ChangeAccount: ChangeAccount,
  DownloadIcon: DownloadIcon,
  DropdownIconWhite: DropdownIconWhite,
  DropdownIcon: DropdownIcon,
  DropdownIconLine: DropdownIconLine,
  DropdownSideIconWhite: DropdownSideIconWhite,
  ExitArrow: ExitArrow,
  BackArrow: BackArrow,
  ...
  Trash: Trash,
  AlertCicle: AlertCicle,
  DoubleCheck: DoubleCheck,
  WithoutTrail: WithoutTrail,
  MoreDotsVertical: MoreDotsVertical,
  MoreDotsHorizontal: MoreDotsHorizontal,
  Mail: Mail,
  Dot: Dot,
  Brain: Brain,
  ...
  CheckInCicle: CheckInCicle,
  CloseInCicle: CloseInCicle,
  RocketIconCommentaryBox: RocketIconCommentaryBox,
  ArrowScrollRight: ArrowScrollRight,
  ArrowScrollLeft: ArrowScrollLeft,
  Bullseye: Bullseye,
  TrashIcon: TrashIcon,
  SearchIcon: SearchIcon,
  ErrorInCicleIcon: ErrorInCicleIcon,
  WarningInCicleIcon: WarningInCicleIcon,
  CorrectInCicleIcon: CorrectInCicleIcon,
  CloseIcon: CloseIcon,
  AddIcon: AddIcon,
  OpenedEye: OpenedEye,
  ...
  QuizSucessError: QuizSucessError,
  Code: Code,
  BarChart: BarChart,
  Course: Course,
  Palette: Palette,
  ...
  Noun: Noun,
  WhatAppBordered: WhatAppBordered,
  MailBordered: MailBordered,
  MessageCheckLine: MessageCheckLine,
  Viewer: Viewer,
  IconNotification: IconNotification,
  LinkedinIconMentor: LinkedinIconMentor,
  Plus: Plus,
  ...
  LampLineIcon: LampLineIcon,
  LampFilledIcon: LampFilledIcon,
  MedalLineIcon: MedalLineIcon,
  MedalFilledIcon: MedalFilledIcon,
  PlayLineIcon: PlayLineIcon,
  PlayFilledIcon: PlayFilledIcon,
  SiteIcon: SiteIcon,
  ...
  WriteIcon: WriteIcon,
  HomeIcon: HomeIcon,
  RocketButton: RocketButton$1,
  StarOutlined: StarOutlined,
  TalkIcon: TalkIcon,
  ThumbsUpIcon: ThumbsUpIcon,
  ThumbsUpCovered: ThumbsUpCovered,
  StepCicleOne: StepCicleOne,
  StepCheckInCicle: StepCheckInCicle,
  StepCicleTwo: StepCicleTwo,
  StepCicleThree: StepCicleThree,
  StepCicleFour: StepCicleFour,
  FowardArrow: FowardArrow,
  AddPeople: AddPeople,
  Books: Books,
  Clock: Clock,
  Load: Load,
  Diamond: Diamond,
  Challenge: Challenge,
  SawBadgeIcon: SawBadgeIcon,
  GoalInviteIcon: GoalInviteIcon
});
...
function ApprovesItem(props) {
    return (jsxRuntime.jsxs("div", { className: style$8.containerItem, children: [jsxRuntime.jsxs("div", { className: style$8.avatar, style: { width: props.size }, children: [jsxRuntime.jsx(Avatar, { src: props.avatar, size: props.size }), jsxRuntime.jsx("span", { style: { marginTop: 4, color: '#FF4D0D', fontWeight: 600 }, children: props.nomeAvatar }), jsxRuntime.jsx("span", { style: { fontSize: 14, color: '#222222', fontWeight: 400 }, children: props.dataAvatar })] }), props.statusApprove === 'aprovar' ?
...
function ContentThumbnails({ label, contentList, variant, src, disabled, icon, onChange, handleClick, handleReloadItens, title, removeContentList, onChangeOrder, isOpen }) {
    ...
    function Exibir() {
        return (jsxRuntime.jsx(reactBeautifulDnd.DragDropContext, { onDragEnd: onDragEnd, children: jsxRuntime.jsx(reactBeautifulDnd.Droppable, { droppableId: "contentListData", children: (provided) => (jsxRuntime.jsx("div", { style: { backgroundColor: '#D1D5DB', height: contentListData.length > 0 ? 'auto' : '462px', width: 270 }, ref: provided.innerRef, children: contentListData?.map((item, index) => {
                        return (jsxRuntime.jsx(reactBeautifulDnd.Draggable, { draggableId: item.title, index: index, children: (provided) => (jsxRuntime.jsxs(ContainerCard$1, { ref: provided.innerRef, ...provided.draggableProps, children: [jsxRuntime.jsxs(Thumbnails$2, { ref: provided.innerRef, ...provided.draggableProps, ...provided.dragHandleProps, children: [jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {})] }), jsxRuntime.jsxs(Thumbnails$2, { ref: provided.innerRef, ...provided.draggableProps, ...provided.dragHandleProps, children: [jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {})] }), jsxRuntime.jsxs(Thumbnails$2, { ref: provided.innerRef, ...provided.draggableProps, ...provided.dragHandleProps, children: [jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {}), jsxRuntime.jsx(VectorEllipse$1, {})] }), jsxRuntime.jsxs("div", { onClick: handleClick, style: { display: 'flex', flexDirection: 'row', alignItems: 'center', height: '100%', cursor: 'pointer' }, children: [iconList[item.type], jsxRuntime.jsx(Title$2, { children: item.title })] }), jsxRuntime.jsx(IconTrash, { className: "trash", onClick: removeContentList, children: jsxRuntime.jsx(TrashIcon, { fill: '#C00F00' }) })] })) }, index));
                    }) })) }) }));
    }
...
const BlockButton = ({ format, icon }) => {
    ...
    return (jsxRuntime.jsx(Button$1, { active: isBlockActive(editor, format, TEXT_ALIGN_TYPES.includes(format) ? 'align' : 'type'), onMouseDown: event => {
            event.preventDefault();
...
const MarkButton = ({ format, icon }) => {
    const editor = slateReact.useSlate();
    return (jsxRuntime.jsx(Button$1, { active: isMarkActive(editor, format), onMouseDown: event => {
            event.preventDefault();
...
function Thumbnails({ variant, src, showSwitchIndividual, handleClickCourse, handleClickNew, handleSwitchAtivarIndividual, handleClickPopOverDelete, handleClickPopOverEdit, title, provided, isDisabled, txtButtonLabel, txtCriarNovoCurso, txtCriarNovoCurso2, txtAtivarCurso, txtPopOverDeleteContent, txtPopOverMoveToTrails, txtPopOverEditContent, isIndividual }) {
    ...
    const [individual, setIndividual] = React.useState(isIndividual ? isIndividual : false);
...
function ThumbnailsDraggable({ variant, src, handleClickCourse, handleClickNew, handleClickContent, handleSwitchAtivarIndividual, title, id, index, isDisabled, txtButtonLabel, txtAtivarCurso, showSwitchIndividual, txtCriarNovoCurso, txtCriarNovoCurso2, handleClickPopOverDelete, handleClickPopOverEdit, handleClickPopOverMove, txtPopOverDeleteContent, txtPopOverEditContent, isIndividual, txtPopOverMoveToTrails }) {
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(reactBeautifulDnd.Draggable, { index: index, draggableId: id, children: (provided) => {
                return (jsxRuntime.jsx(Thumbnails, { src: src, isDisabled: isDisabled, handleClickCourse: handleClickCourse, handleSwitchAtivarIndividual: handleSwitchAtivarIndividual, handleClickNew: handleClickNew, handleClickContent: handleClickContent, variant: variant, title: title, id: id, isIndividual: isIndividual, showSwitchIndividual: showSwitchIndividual, index: index, provided: provided, txtButtonLabel: txtButtonLabel, txtAtivarCurso: txtAtivarCurso, txtCriarNovoCurso: txtCriarNovoCurso, txtCriarNovoCurso2: txtCriarNovoCurso2, handleClickPopOverDelete: handleClickPopOverDelete, handleClickPopOverEdit: handleClickPopOverEdit, handleClickPopOverMove: handleClickPopOverMove, txtPopOverDeleteContent: txtPopOverDeleteContent, txtPopOverEditContent: txtPopOverEditContent, txtPopOverMoveToTrails: txtPopOverMoveToTrails }));
            } }, id.toString()) }));
}
...
handlePopOverMove, handlePopOverEdit, handlePopOverTrailEdit, handlePopOverTrailDelete, handleSwitchActiveTrail, onSetNameTrail, handleSwitchAtivarIndividual, handleDeleteCourse, handleDeleteCourseTrail, handleMessageError, handleUpdateTrail, txtPopOverDeleteContent, txtPopOverEditContent, txtPopOverMoveToTrails, textMeusConteudos, textTotalDe, textRegistros, textMinhasTrihas, txtAtivarCurso, txtButtonLabel, txtCriarNovoCurso, txtAtivarTrilha }) {
    ...
    return (jsxRuntime.jsx(styled.ThemeProvider, { theme: FRSTTheme, children: jsxRuntime.jsx(reactBeautifulDnd.DragDropContext, { onDragEnd: handleDragEnd, children: jsxRuntime.jsx(jsxRuntime.Fragment, { children: trails && (jsxRuntime.jsx(AccordionTrack, { trailsData: trails, courseData: courseData, handleSwitchActiveTrail: (index, active) => {
...
function LateralMenu$1({ label, onClick, button, beginComponent, activeBeginIcon, selected, subItems, hiddenIconDropArrow, style }) {
    ...
    return (jsxRuntime.jsx(styled.ThemeProvider, { theme: FRSTTheme, children: subItems && subItems.length > 0 ?
            jsxRuntime.jsxs(WrapperCompound, { isOpen: isActive, style: { ...style, maxHeight: isActive ? getSizeCompound() : '40px' }, children: [jsxRuntime.jsxs(WrapperItem, { active: isActive, onClick: (e) => setIsActive(!isActive), style: { ...style, margin: 0, padding: 0, justifyContent: 'space-between' }, children: [jsxRuntime.jsxs(WrapperItem, { style: { background: 'transparent', width: '100%' }, children: [beginComponent &&
                                ...
                                jsxRuntime.jsx(WrapperButton, { children: jsxRuntime.jsx(Button$2, { label: button.label, handleClick: (e) => button.onClick(e), variant: button?.variant ? button.variant : 'primary' }) }), !hiddenIconDropArrow &&
            ...
            :
                jsxRuntime.jsxs(WrapperItem, { active: isActive, style: { ...style, margin: 0, padding: 0, justifyContent: 'space-between' }, children: [jsxRuntime.jsxs(WrapperItem, { style: { background: 'transparent', width: '100%' }, onClick: (e) => onClick(e), children: [beginComponent &&
                                    jsxRuntime.jsx(WrapperComponent, { active: isActive, children: isActive ? activeBeginIcon ? activeBeginIcon : beginComponent : beginComponent }), jsxRuntime.jsx(WrapperMainLabel, { active: isActive, style: { marginLeft: beginComponent ? '8px' : '0px' }, children: label })] }), button && button?.label &&
                            jsxRuntime.jsx(WrapperButton, { children: jsxRuntime.jsx(Button$2, { label: button.label, handleClick: (e) => button.onClick(e), variant: button?.variant ? button.variant : 'primary' }) })] }) }));
}
...
function LateralMenu({ variant, hiddenButtonHeader, avatar, name, channel, button, listOptions, style }) {
    return (jsxRuntime.jsx(styled.ThemeProvider, { theme: FRSTTheme, children: jsxRuntime.jsxs(WrapperCard$1, { style: { ...style }, children: [jsxRuntime.jsxs(WrapperHeader, { children: [jsxRuntime.jsx(Avatar, { src: avatar.src, alt: avatar.alt ? avatar.alt : 'Image profile avatar', size: avatar.size ? avatar.size : '80px' }), jsxRuntime.jsx(NameProfile, { children: name }), channel &&
                            ...
                            jsxRuntime.jsx(WrapperButton$1, { children: !channel ?
                                    ...
                                    :
                                        jsxRuntime.jsx(Button$2, { variant: 'link', label: button.label, handleClick: (e) => button.onClick(e) }) }), jsxRuntime.jsx(HR, {})] }), listOptions && listOptions.length > 0 && listOptions.map((item, index) => {
