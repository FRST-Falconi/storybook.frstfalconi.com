...
export declare const StepBar: import("styled-components").StyledComponent<"div", any, IComponente, never>;
export declare const StepBoxTitle: import("styled-components").StyledComponent<"a", any, IComponente, never>;
export declare const StepBoxDescription: import("styled-components").StyledComponent<"p", any, {}, never>;
export declare const CheckCircle: import("styled-components").StyledComponent<"div", any, ICheckCircle, never>;
//# sourceMappingURL=onboardingProgressMenuStyles.d.ts.map