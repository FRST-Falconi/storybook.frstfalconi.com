...
export declare const ContainerThumbnails: import("styled-components").StyledComponent<"div", any, {}, never>;
...
export declare const TypographyAtivar: import("styled-components").StyledComponent<"p", any, IImageBackground, never>;
