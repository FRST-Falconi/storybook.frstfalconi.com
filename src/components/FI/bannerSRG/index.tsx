...
export default function BannerSRG(props: IBannerSRG) {
    return (
        <ThemeProvider theme={FRSTTheme}>
            <ContainerTotal 
                isExtendedVersion = {props?.isExtendedVersion}
                bannerLarge={props?.bannerSRG?.large} 
                bannerNormal={props?.bannerSRG?.normal} 
                bannerResponsive={props?.bannerSRG?.responsive} 
                style={{...props.style}}
            >
                <ContainerBanner>
                ...
                <VersionExtended isExtendedVersion={props.isExtendedVersion} heightExtended={props.heightExtended}/>
            </ContainerTotal>
        </ThemeProvider>
    )
}