...
export default function SelectLXP({ placeholder, defaultValue, children, onChange, loading }: SelectProps) {
          ...
          <DropDownListContainer>
            <DropDownList>
              <div onClick={handleChange}>
                <SelectLXPContext.Provider value={{ selected: selectedOptionValue }}>
                  {children}
                </SelectLXPContext.Provider>
              </div>
            </DropDownList>
          </DropDownListContainer>
        )}
