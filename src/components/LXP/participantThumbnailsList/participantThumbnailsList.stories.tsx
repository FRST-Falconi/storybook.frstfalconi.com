...
import ParticipantThumbnailsList from './index'

export default {
  title: 'LXP/ParticipantThumbnailsList',
  component: ParticipantThumbnailsList
}

const Template = (args) => <ParticipantThumbnailsList {...args} />
