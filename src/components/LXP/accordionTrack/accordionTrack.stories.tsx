      ...
      trail_course: [
        {
          ...
          course: {
            ...
            settings: {
              cover_full_url:
                'https://cdn.discordapp.com/attachments/1001105882358226955/1058104301844693122/image.png',
              cover_thumb_url:
                'https://cdn.discordapp.com/attachments/1001105882358226955/1058104301844693122/image.png',
              cover_video_url:
                'https://cdn.discordapp.com/attachments/1001105882358226955/1058104301844693122/image.png'
...
Opened.args = {
  onNewTrail: () => {
    alert(`Adicionando novo Conteúdo`)
  },
  handleEditCourse: (id) => {
    alert(`Selected id: ${id}`)
  },
  handlePopOverMove: (id) => {
    alert(`Move id: ${id}`)
  },
  handlePopOverEdit: (id) => {
    alert(`Content Edit id: ${id}`)
  },
  handlePopOverDelete: (id) => {
    alert(`Content Deleted id: ${id}`)
  },
  handleMessageError: (error) => {
    alert(error)
  },
  handlePopOverTrailEdit: (id) => {
    alert(`Trail Edit id: ${id}`)
  },
  handlePopOverTrailDelete: (id) => {
    alert(`Trail Deleted id: ${id}`)
  },
  handleClickPopOverMoveToTrail: (id) => {
    alert(id)
  },
  ...
  onSetNameTrail: (idTrail, name) => {
    alert(`TrailName: ${idTrail} ${name}`)
  },
...
Loading.args = {
  ...
  txtAtivarTrilha: 'Ativar trilha',
  txtCriarNovoCurso: 'Criar novo Conteúdo',
  txtPopOverEditContent: 'Edit module',
  txtPopOverMoveToTrails: 'Move to Trails',
  ...
  txtTrailsPopOverDelete: 'Excluir trilha',
  txtPlacerolderInputNameTrail: 'Enter track name',
  txtPopOverEditContentActivity: 'Edit content'
}
